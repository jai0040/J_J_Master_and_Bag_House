            ...
            <div class="container text-light">
                <div class="w-100 d-flex justify-content-between">
                    <div>
                        ...
                        <a class="navbar-sm-brand text-light text-decoration-none" href="mailto:jjmaster0040@gmail.com">jjmaster0040@gmail.com</a>
                        ...
                        <div class="row p-5">
                            ...
                            <div class="col-lg-6 mb-0 d-flex align-items-center">
                                <div class="text-align-left align-self-center">
                                    <h1 class="h1 text-success"><b>Travel Bag</b></h1>
                                    <h3 class="h2">Most populer oue product</h3>
                                    <p>
                                        Travel Zay Shop is an eCommerce HTML5 CSS template with latest version of Bootstrap 5 (beta 1). 
                        ...
                        <div class="row p-5">
                            ...
                            <div class="col-lg-6 mb-0 d-flex align-items-center">
                                <div class="text-align-left">
                                    <h1 class="h1 text-success"><b>School Bag</b></h1>
                ...
                <div class="carousel-item">
                    <div class="container">
                        <div class="row p-5">
                            ...
                            <div class="col-lg-6 mb-0 d-flex align-items-center">
                                <div class="text-align-left">
                                    <h1 class="h1 text-success"><b>Office Bag</b></h1>
        ...
        <section class="container py-5">
            <div class="row text-center pt-3">
                <div class="col-lg-6 m-auto">
                    ...
                    <p>
                        This is our exclusive products
                    </p>
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-md-4 p-5 mt-3">
                    <a href="#">
                        <img src="./assets/img/category_img_01_Tuition Bag.jpg" class="rounded-circle img-fluid border"></a>
                    <h5 class="text-center mt-3 mb-3">Tuition Bag</h5>
                    <p class="text-center"><a class="btn btn-success">Go Shop</a></p>
                </div>
                <div class="col-12 col-md-4 p-5 mt-3">
                    <a href="#">
                        <img src="./assets/img/category_img_02_Ladies Purse.jpg" class="rounded-circle img-fluid border"></a>
                    <h2 class="h5 text-center mt-3 mb-3">Ladies Purse</h2>
                    <p class="text-center"><a class="btn btn-success">Go Shop</a></p>
                </div>
                <div class="col-12 col-md-4 p-5 mt-3">
                    <a href="#">
                        <img src="./assets/img/category_img_03_School Bag.png" class="rounded-circle img-fluid border"></a>
                    <h5 class="text-center mt-3 mb-3">Duffle Bag</h5>
                    <p class="text-center"><a class="btn btn-success">Go Shop</a></p>
                </div>
            </div>
        </section>
        ...
        <section class="bg-light">
            <div class="container py-5">
                <div class="row text-center py-3">
                    <div class="col-lg-6 m-auto">
                        <h1 class="h1">Upcoming Product</h1>
                        <p>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled d-flex justify-content-between">
                                    ...
                                    <li class="text-muted text-right">₹800</li>
                                </ul>
                                <a href="shop-single.html" class="h2 text-decoration-none text-dark">Ladies Purse</a>
                                <p class="card-text">
                                    We are starting to design and manufacturing a new and fancy purse for women, and the material of this product is lather and form. Also, this product is very light.
                                </p>
                    ...
                    <div class="col-12 col-md-4 mb-4">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <a href="shop-single.html" class="h2 text-decoration-none text-dark">Tiffin Bag</a>
                                <p class="card-text">
